<!-- Make sure that you executed "signaler.js" or "ssl.js" instead of "simple.js"!! -->
...
<html lang="en">
    <head>
        <title>WebRTC » WebSockets ® Muaz Khan</title>
        ...
        <script src="//www.webrtc-experiment.com/websocket/PeerConnection.js"> </script>
    </head>
        ...
        <article>
            <header style="text-align: center;">
                <h1>
                    ...
                    » 
                    <a href="https://github.com/muaz-khan/WebRTC-Experiment/tree/master/websocket" target="_blank">WebSockets</a>
                    ® 
            ...
            <section class="experiment">                
                <section>
                    <span>
                        Private ?? <a href="" target="_blank" title="Setup Private Room!"><code><strong id="unique-token">#123456789</strong></code></a>
                    </span>
...
var peer = new PeerConnection(websocket);
        ...
        <a href="https://github.com/muaz-khan/WebRTC-Experiment/tree/master/websocket-over-nodejs" class="fork-right"></a>
